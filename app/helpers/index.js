...
// Find a single user based on the key
...
let createNewUser = profile => {
   return new Promise((resolve, reject) => {
      let newChatUser = new database.userModel({
...
// Find a chatroom by the given name
...
module.exports = { route, findOne, createNewUser, findById, isAuthenticated, findRoomByName,
   randomHex, findRoomById, addUserToRooms, removeUserFromRoom };